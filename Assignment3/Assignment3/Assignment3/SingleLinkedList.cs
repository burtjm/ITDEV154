...
namespace Assignment3
{
    class SingleLinkedList
    {
        ...
        private Node Merge1(Node p1, Node p2)
        {
            ...
            /* If second list has finished and there are elements left in the first list */
            while (p1 != null)
            {
                pM.link = new Node(p1.info);
                p1 = p1.link;
            ...
            /* If first list has finished and there are elements left in second list */
            while (p2 != null)
            {
                pM.link = new Node(p2.info);
                p2 = p2.link;
        ...
        {
            if (listStart == null || listStart.link == null) /* If empty list or one element */
                return listStart;
